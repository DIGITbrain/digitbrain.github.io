...
An optional description for the Administrative data section may appear here. 
...
:   **Auto-generated**-*URL*- More detailed specification of data source characteristics (doc, pdf, …)
    === "Example"
        ``` yaml     
...
An optional description for the Search support section may appear here. 
...
An optional description for the Datakind specification section may appear here. 
...
:   **Auto-generated**-*list of strings*- Format/encoding of the data produced or consumed by the data resource as a MIME type (IETF RFC 6838 https://www.sitepoint.com/mime-types-complete-list/). More than one can appear here (remote directory with several files).
    === "Example"
        ``` yaml     
...
An optional description for the Data access specification section may appear here. 

`DATA_SOURCE_TYPE`

:   **Auto-generated**-*string*- The exact type of the data resource. Typically corresponds to the scheme part (protocol://) of DATA_URI.
    === "Example"
        ``` yaml     
...
:   **Auto-generated**-*URI*- Accessibility of the data resource, including host, port information, protocol, and other fields (path is protocol dependent, can be a topic name). GUI may show host, port, path separately. Hidden at search. Format: protocol://host:port/path 
    === "Example"
        ``` yaml     
...
:   **Auto-generated**-*list of enums*- One or more authentication types that can be accepted by the storage resource.
    === "Example"
        ``` yaml     
...
An optional description for the Open parameters section may appear here. 

`DATA_CREDENTIALS`

:   **Auto-generated**-*OPEN*- Credentials (e.g. string/json, zip, config file)
    === "Example"
        ``` yaml     
        DATA_CREDENTIALS: nan
        ```


### Further access clauses (extensible)

An optional description for the Further access clauses (extensible) section may appear here. 
...
An optional description for the Data content semantics section may appear here. 
...
:   **Optional**-*string*- Further restriction/specialization of DATA_SCHEMA, “general” schema.
    ...
    === "Example"
        ``` yaml     
        DATA_SCHEMA_ADDITIONAL_ATTRIBUTES: nan
        ```
